...
public class TestcasesUsingJavaScript {
	WebDriver driver;
	PageObjects page;
	WebDriverWait wait;
...
//		System.setProperty("webdriver.chrome.driver", "");
	...
	/*
	 * 
	 * These test cases will use javascript to remove style from  
	 * the original hidden html file upload control and using it for uploading files
	 * 
	 */
	...
	public void checkvalidInput(String username, String password) {
		...
		page.files.click();
		page.addFiles.click();
		page.makeFileUploadAvailable().sendKeys(System.getProperty("user.dir") + File.separator + "testdata"  + File.separator + "file.pdf");
	...
	public void checkInvalidInput(String username, String password) {
		...
		page.files.click();
		page.addFiles.click();
		page.makeFileUploadAvailable().sendKeys(System.getProperty("user.dir") + File.separator + "testdata"  + File.separator + "file.jpg");
